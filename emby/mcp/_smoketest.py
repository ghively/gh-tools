...
show("emby_categories(genres)", E.emby_categories("genres", include_types="Movie", limit=5))
show("emby_categories(studios)", E.emby_categories("studios", include_types="Movie", limit=5))
show("emby_categories(persons)", E.emby_categories("persons", person_types="Actor", limit=5))
show("emby_categories(artists)", E.emby_categories("artists", limit=5))
show("emby_categories(years)", E.emby_categories("years", include_types="Movie", limit=5))
if item_id:
    show("emby_similar", E.emby_similar(item_id, limit=5))
show("emby_latest(movies)", E.emby_latest(include_types="Movie", limit=5, fields="DateCreated"))
