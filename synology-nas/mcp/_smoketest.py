...
tools = [
    ...
    ("synology_firewall_rules",        server.synology_firewall_rules),
    ("synology_autoblock_list",        lambda: server.synology_autoblock_list(limit=5)),
    ("synology_certificates_list",     server.synology_certificates_list),
    ("synology_ups_status",            server.synology_ups_status),
